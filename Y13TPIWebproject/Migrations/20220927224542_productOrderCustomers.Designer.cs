...
namespace Y13TPIWebproject.Migrations
{
    ...
    [Migration("20220927224542_productOrderCustomers")]
    partial class productOrderCustomers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Y13TPIWebproject.Areas.Identity.Data.Y13TPIWebprojectUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Y13TPIWebproject.Areas.Identity.Data.Y13TPIWebprojectUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OrderProduct", b =>
                {
                    b.HasOne("Y13TPIWebproject.Models.Order", null)
                        .WithMany()
                        .HasForeignKey("OrdersOrderID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Y13TPIWebproject.Models.Product", null)
                        .WithMany()
